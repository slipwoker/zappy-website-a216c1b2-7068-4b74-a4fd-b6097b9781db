  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (minLength && !VALIDATORS.minlength(value, minLength)) {
        showError(field, ERROR_MESSAGES.minlength + ' (min ' + minLength + ' characters)');
        return false;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "PRO POINT משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a216c1b2-7068-4b74-a4fd-b6097b9781db',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a216c1b2-7068-4b74-a4fd-b6097b9781db';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a216c1b2-7068-4b74-a4fd-b6097b9781db';
